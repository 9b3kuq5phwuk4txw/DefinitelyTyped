...
const options: expressLegacyExpires.Options = { now: () => Date.parse('2023-09-25T09:00:00Z') };

expressLegacyExpires(); // $ExpectType RequestHandler<ParamsDictionary, any, any, ParsedQs, Record<string, any>>
expressLegacyExpires({}); // $ExpectType RequestHandler<ParamsDictionary, any, any, ParsedQs, Record<string, any>>
expressLegacyExpires({ now: () => Date.parse('2023-09-25T09:00:00Z') }); // $ExpectType RequestHandler<ParamsDictionary, any, any, ParsedQs, Record<string, any>>
